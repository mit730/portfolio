...
const ExperienceCard = ({ title, company, location, type, date, description }: { title: string, company: string, location: string, type: string, date: string, description?: string[] }) => (
  <div className="border-b border-gray-200 dark:border-gray-700 py-6 last:border-0">
    <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
      ...
      <div className="flex flex-col items-end gap-2">
        ...
        <span className="flex items-center gap-1 text-sm text-gray-500 dark:text-gray-400"><FaCalendarAlt className="text-gray-400" /> {date}</span>
      </div>
    </div>
      ...
      <div className="container mx-auto px-8 md:px-32">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed max-w-3xl">
            Experienced MERN Stack Developer with more than 3+ years of proficiency in building scalable
            ...
            delivering high-performance code.  </p>
        </div>
